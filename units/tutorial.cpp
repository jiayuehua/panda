...
int tutorial_main(void)
{
    ...
    //quantity<s1::length,float>  l1(1.0*s1::length1);//jia
    quantity<s1::length,double>  l1(1.0*s1::length1);
    quantity<s2::length,double> l2(1.5*l1);
    //quantity<s1::length,float>  l3(2.0*l2/3.0);//jia
    quantity<s1::length,double>  l3(2.0*l2/3.0);

    //quantity<s1::time,float>    t1(1.0*s1::time1);//jia
    quantity<s1::time,double>    t1(1.0*s1::time1);
    quantity<s2::time,double>   t2(1.5*t1);
    //quantity<s2::time,double>   t = static_cast<quantity<s2::time,double> >(l1);
